...
storiesOf('<Route>', module)
   .add('Children', () => {
      return (
         <Router route='/bar'>
            ...
            <Route match='/bar'><div>bar 2</div></Route>
   ...
   .add('Exact', () => {
      return (
         <Router route='/foo/bar'>
            <Route match='/foo' exact>foo</Route>
            <Route match='/foo/bar' exact>foo/bar</Route>
         </Router>
      );
   })
   ...
   .add('Partial match', () => {
      return (
         <Router route='/foo/bar'>
            <Route match='/fo'><div>/fo</div></Route>
            <Route match='/foo'><div>/foo</div></Route>
            <Route match='/foo/bar'><div>/foo/bar</div></Route>
         </Router>
      );
   })
